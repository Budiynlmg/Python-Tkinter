...
class Login:
    ...
    def prosesLogin(self, event=None):
        ...
        # logika pemrograman
        if nmUser=='':
            mb.showwarning('Warning !!', 'Username can not be empty!', parent=self.induk)
            self.entUser.focus_set()
        elif passUser=='':
            mb.showwarning('Warning !!', 'password can not be empty!', parent=self.induk)
            ...
            mb.showwarning('Warning !!', 'Username or Keyword WRONG!!', parent=self.induk)
            self.Hapus()
