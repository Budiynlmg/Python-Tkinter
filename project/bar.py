...
class SplashScreen:
    ...
    def aturWindow(self):
        ...
        Label(self.parent,  text="Loading",bg="#526060",fg="white", font=("Helvetica", 20), width=9, height=2).pack(side=TOP,anchor=N,fill=X)
        s = ttk.Style()
        s.theme_use('alt')
        s.configure("red.Horizontal.TProgressbar", background='#2529E8', foreground="white", relief=FLAT,bd=0,height=2)
