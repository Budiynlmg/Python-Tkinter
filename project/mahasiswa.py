...
class Petugas:
        ...
        def OnDoubleClick(self, event):
                ...
                con = pymysql.connect(db="db_mahasiswa", user="root", passwd="", host="localhost", port=3306,autocommit=True)
                cur = con.cursor()
                sql = "SELECT mahasiswa_nama, mahasiswa_tgl_lahir, mahasiswa_alamat,mahasiswa_no_hp FROM mahasiswa WHERE mahasiswa_kode = %s"
        ...
        def aturKomponen(self):
                ...
                Label(frameWin, text='MAHASISWA',bg="blue",fg="white").pack(side=LEFT,padx=20)
                buttonx = Button(frameWin, text="X",fg="white", bg="#FF334F", width=6, height=2,bd=0,\
                ...
                Label(mainFrame, text='Nim Mahasiswa').grid(row=1, column=0, sticky=W,padx=20)
                ...
                Label(mainFrame, text="Nama Mahasiswa").grid(row=2, column=0, sticky=W,padx=20)
                ...
                self.btnDelete = Button(btnFrame, text='Delete',\
                                        ...
                                        relief=FLAT, bd=2, bg="#FF334F", fg="white",activebackground="#444",activeforeground="white")
        ...
        def onSave(self):
                ...
                if len(cHari) == 0 and len(cBulan) == 0 and len(cTahun):
                        ...
                        cur = con.cursor()
                        sql = "INSERT INTO mahasiswa (mahasiswa_kode,mahasiswa_nama, mahasiswa_tgl_lahir, mahasiswa_alamat,mahasiswa_no_hp)"+\
                              "VALUES(%s,%s,%s,%s,%s)"
        ...
        def onUpdate(self):
                ...
                if len(cKode) == 0:
                        ...
                        con = pymysql.connect(db='db_mahasiswa', user='root', passwd='', host="localhost",\
                        ...
                        sql = "UPDATE mahasiswa SET mahasiswa_nama=%s, mahasiswa_tgl_lahir=%s, mahasiswa_alamat=%s,mahasiswa_no_hp=%s WHERE mahasiswa_kode =%s"
